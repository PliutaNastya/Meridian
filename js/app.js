(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-about__slider")) new core(".slider-about__slider", {
                ...
                on: {
                    init: function(swiper) {
                        ...
                        const allSlidesItems = document.querySelectorAll(".slider-about__slide:not(.swiper-slide-duplicate)");
            ...
            if (document.querySelector(".products-card__slider")) new core(".product-card__slider", {
            ...
            if (document.querySelector(".images-product")) {
                var sliderThumbnail = new core(".gallery-thumbs", {
        ...
        da.init();
        const searchField = document.querySelector(".menu__search_field");
        const searchIcon = document.querySelector(".menu__search_icon");
        ...
        if (document.querySelector(".filter__category")) document.querySelector(".filter__category").addEventListener("click", (function(e) {
            if (window.innerWidth < 992) document.querySelector(".filter__items").classList.toggle("_active");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
